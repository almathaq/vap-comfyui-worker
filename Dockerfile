...
RUN cd /comfyui/custom_nodes && git clone https://github.com/storyicon/comfyui_segment_anything && pip install -r comfyui_segment_anything/requirements.txt
...
RUN comfy model download --url "https://huggingface.co/ShilongLiu/GroundingDINO/resolve/main/GroundingDINO_SwinT_OGC.cfg.py" --relative-path models/grounding-dino --filename GroundingDINO_SwinT_OGC.cfg.py
